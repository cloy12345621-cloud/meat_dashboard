...
with tab1:
    # ------------------------------------------
    # [데이터 로드 엔진] 1번, 3번 데이터 연동 및 방어막 구축
    # ------------------------------------------
    @st.cache_data(ttl=3600)
    def get_combined_data():
        # 기본 예비용 리얼 데이터셋 선언 (에러 발생 시 무조건 이 데이터가 살아남음)
        ...
        try:
            ...
            if 'Grid_20161216000000000428_1' in res:
    ...
    # 함수를 실행하여 확실하게 데이터를 확보 (에러가 나도 무조건 fallback_df가 들어옴)
