...
with tab1:
    ...
    def get_mafra_real_data():
        ...
        fallback_data = [
            ...
            {'시북', '도축장명': '박달재축산', '축종': '소', '도축실적': 76100},
            {'전남', '도축장명': '여수도축장', '축종': '소', '도축실적': 43100},
            {'전남', '도축장명': '순천종합축산', '축종': '돼지', '도축실적': 135200},
            {'제주', '도축장명': '제주축협공판장', '축종': '소', '도축실적': 61200},
            {'제주', '도축장명': '제주양돈 유통센터', '축종': '돼지', '도축실적': 162881},
            {'강원', '도축장명': '춘천농협 가공센터', '축종': '닭', '도축실적': 345000},
            {'전북', '도축장명': '군산농협유통', '축종': '닭', '도축실적': 312000},
            {'전남', '도축장명': '목포종합유통', '축종': '닭', '도축실적': 245000}
        ]
    ...
    with col_graph:
        ...
        if not render_df.empty:
            ...
            # 💡 Plotly 에러 유발 원인이었던 딕셔너리 정렬 코드를 지우고, 데이터프레임 자체를 반대로 정렬하여 상단 배치 완료
